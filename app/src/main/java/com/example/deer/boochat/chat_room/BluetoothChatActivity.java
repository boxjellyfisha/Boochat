...
public class BluetoothChatActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDBManager=new ListDBItemDAO(BluetoothChatActivity.this);
    ...
    public class UpdateReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if(Constants.SCANNER_SERVICE_CHANGE.equals(action)) {
                ...
                Toast.makeText(BluetoothChatActivity.this,"connected", Toast.LENGTH_SHORT).show();
            }
            else if (BluetoothLeService.ACTION_GATT_DISCONNECTED.equals(action)) {
                Toast.makeText(BluetoothChatActivity.this,"disconnected", Toast.LENGTH_SHORT).show();
        ...
        switch(flag) {
            ...
            case 4:
                ...
                Snackbar.make(findViewById(android.R.id.content), "Connect to ..."+tmpSerial, Snackbar.LENGTH_SHORT)
                        .show();
                mBluetoothLeService.connect(bundle.getString(Constants.DEVICE_ADDRESS),1);
                break;
        }
    }
    /*-------------------------------------------------------------------------------------------------------------------------------------------*/
